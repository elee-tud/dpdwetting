...
wallgap=5.0
unitcell=0.5
options=['-b', '-w', '-i', '-o', '-x', '-y', '-z']
types=['float', 'float', 'str', 'str', 'float', 'float', 'float']
defaults=[10.0, 5.0, 'nowall.gro', 'wall.gro', 0, 0, 0]
nbox, wallgap, inname, outname, boxx, boxy, boxz=getopt(sys.argv, options, types, defaults)
